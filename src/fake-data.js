...
const USER_ID_1 = '5C1HpOCOBqggxZ3xruMO3OsvtDn1';
const USER_ID_2 = '0ieBbq2yAAhbc79yeWEIIJ5pU2C2';
const USER_ID_3 = 'n2Ityv9IMwXx6P3FnXhvkzqHHix1';
...
module.exports.messages = [{
    ...
    userId: USER_ID_3,
    groupId: GROUP_ID_1,
    text: 'Hey Murtaza, welcome to the group!'
}, {
    userId: USER_ID_2,
    groupId: GROUP_ID_2,
